...
for i = 1:length(myFiles)
    ...
    if atlas ~= "EveType3" || stat ~= "beta" ||variable ~="Motion" || measure ~= "FA_std"
        continue
    end
    ...
    figure(1); clf; set(gcf, 'Position', [100 100 1000 1000]);
    xlabel("x")
    ylabel("y")
    zlabel("z")
...
%     lt_out3 = light("Color", [1,1,1], "Style", "local", "Position", [0 0 -20]);
    ...
    path_video = fullfile(path_video_folder,append(atlas,'-',measure,'-',stat,'-',variable,'-','lightcombo-2'));
