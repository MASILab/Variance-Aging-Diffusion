...
imageio.mimsave('/home/local/VANDERBILT/gaoc11/Projects/Variance-Aging-Diffusion/Experiments/CI_tutorial/CI_positive_hetero_v1.gif', figs_data, format='gif', fps=1)
