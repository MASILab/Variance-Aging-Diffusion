...
# df.to_csv('/home/local/VANDERBILT/gaoc11/Projects/Variance-Aging-Diffusion/Data/BLSA_eddy_movement_rms_change_scan_vs_rescan_20230208.csv', index=False)
df = pd.read_csv('/home/local/VANDERBILT/gaoc11/Projects/Variance-Aging-Diffusion/Data/BLSA_eddy_movement_rms_change_scan_vs_rescan_20230208.csv')

# Raincloud plot
# hyperparams for figure
figure_save = '/home/local/VANDERBILT/gaoc11/Projects/Variance-Aging-Diffusion/Figure/figs/figure_raincloud_motion_vs_dti_v2.png'
...
axes[0] = sns.boxplot(data = df,
                    ...
                    medianprops=dict(color= '#ff8121', linewidth=1.5),
                    ax=axes[0])    
